...
# Build runtime deb
rm -rf build
cmake -DCMAKE_BUILD_TYPE=RelWithDebInfo -DGF_BUILD_GAMES=OFF -DGF_BUILD_EXAMPLES=OFF -DGF_BUILD_DOCUMENTATION=OFF -DBUILD_TESTING=OFF -DCMAKE_UNITY_BUILD=ON -DGF_PACKAGE_SUFFIX="$CPACK_PACKAGE_SUFFIX" -S gf -B build
